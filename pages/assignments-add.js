      ...
      <div className="container-xxl py-5">
        <div className="container">
          <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 className="mb-5">ADD ASSIGNMENTS</h1>
          </div>
              ...
              <div className="col-md-6">
                <div className="form-floating">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label htmlFor="name">ASSIGNMENT SUBJECT</label>
                </div>
              </div>
              <div className="col-12">
                <div className="form-floating">
                  <textarea
                    ...
                    onChange={handleChange}
                  ></textarea>
                  <label htmlFor="desc">ASSIGNMENT CONTENT</label>
                </div>
              </div>
              <div className="col-12">
      ...
      <div className="container-xxl py-5">
        <div className="container">
          <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 className="mb-5">YOUR TOTAL ADDED ASSIGNMENTS</h1>
          </div>
          ...
          {isLoading ? (
            ...
            services.map((elem) => (
              <div
                ...
                key={elem._id}
              >
                <div className="service-item admin-service pt-3 h-100">
                  <div className="p-4">
